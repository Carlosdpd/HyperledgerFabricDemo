...
var createDirectory = require('./utils/create_dir.js');
var fileUpload = require('express-fileupload');
var deleteFile = require('./utils/delete_file.js');
...
app.post('/upload', async function(req, res, next) {
  ...
  createDirectory(__dirname + '/public/files/' + projectName);
  uploadFile.mv(
    `${__dirname}/public/files/${projectName}/${fileName}`,
    function (err) {
      if (err) {
...
app.get('/getFiles/:project', async function(req, res, next) {
  let projectName = req.params.project;

  fs.readdir(__dirname + '/public/files/' + projectName, function(error, content) {
    if (error) {
       res.send(error);
       return error;
    }
...
//This might need to be reviewed.
app.get('/download/:project/:fileName', async function(req, res, next) {
  let projectName = req.params.project;
  let fileName = req.params.fileName;

  var filePath = __dirname + '/public/files/' + projectName + '/' + fileName;
...
app.post('/deleteFile', async function(req, res, next) {
  ...
  try {
    deleteFile(__dirname + '/public/files/' + projectName + '/' + fileName);
    res.send('200');
